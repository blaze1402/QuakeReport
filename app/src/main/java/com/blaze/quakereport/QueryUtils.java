    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                JSONObject currentPosition = earthquakeArray.getJSONObject(i);
                JSONObject properties = currentPosition.getJSONObject("properties");
